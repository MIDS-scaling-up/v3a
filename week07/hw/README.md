...
We are conducting an in-class competition on Kaggle. You can find instructions [here](https://www.kaggle.com/competitions/bird-watch-spring-2023). You may need to create a user on the platform first.
...
There is a public leaderboard which will be visible through the competition. On the deadline (`Midnight UTC, March 18th`), the challenge will close and the private leaderboard rankings will be revealed!! 
