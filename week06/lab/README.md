...
Due to this issue and the overall camera performace, for this lab/homework, I strongly recommend using Parallels over VMWare Fusion if you are using a M1 or M2 mac.
